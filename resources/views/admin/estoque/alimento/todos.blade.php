...
@section('title', 'Estoque Alimentos')
@section('css')
...
<script type="text/javascript">
    $(function() {
    	...
    	htmlPag='<span id="pg_n"></span><button class="pull-right btn btn-default next">Proximo ></button>' +
				'<button class="btn btn-default prev pull-right">< Anterior</button>';
