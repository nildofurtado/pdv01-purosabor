...
<h3>Novo Alimento para estoque</h3>
@stop
@section('content')
@include('admin.modal')
<meta name="csrf-token" content="{{ csrf_token() }}">
<div id="modal_content"></div>
<form id="cadastro" action="{{route('estoque.alimento.save')}}" method="POST">
    <div class="row">
    	<div class="col-md-6">
			<div id="fornecedor" class="form-group">
				<label for="categoria">Categoria</label>
				<div id="categoria">@include('admin.estoque.categoria')</div>
			</div>
    		...
    		<div id="fornecedor" class="form-group">
    			...
    			<div class="form-group">
    				<label for="codigo">Código / EAN</label>
					<input id="codigo" type="text" required="required" name="codigo" class="form-control"
...
$(function() {
	...
	$('#cadastro').on('keyup keypress', function(e) {
     ...
     $('#cadastro').submit(function(e) {
      	$.post("{{route('estoque.alimento.save')}}", $("#cadastro").serialize(), function( data )	{
